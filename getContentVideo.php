<?php
    ...
    if(!empty($id)){
        ...
        $query = $db->query("SELECT w.titulo, v.titulo, w.descripcion, fecha, lugar, url FROM workshop w, video v, video_es_workshop vw WHERE w.id_workshop = vw.id_workshop AND vw.id_video = v.id_video AND v.id_video= $id");
